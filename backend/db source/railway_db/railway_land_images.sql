...
CREATE TABLE `land_images` (
  ...
  KEY `ix_land_images_land_id` (`land_id`),
  CONSTRAINT `fk_img_land` FOREIGN KEY (`land_id`) REFERENCES `lands` (`land_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `land_images` WRITE;
/*!40000 ALTER TABLE `land_images` DISABLE KEYS */;
/*!40000 ALTER TABLE `land_images` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-11-11 16:14:14
